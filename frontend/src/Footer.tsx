        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services/residential-framing" className="text-gray-700 hover:text-[#B95927] transition text-lg">
                  Residential Framing
                </Link>
              </li>
              <li>
                <Link href="/services/commercial-framing" className="text-gray-700 hover:text-[#B95927] transition text-lg">
                  Commercial Framing
                </Link>
              </li>
              <li>
                <Link href="/services/custom-home-framing" className="text-gray-700 hover:text-[#B95927] transition text-lg">
                  Custom Home Framing
                </Link>
              </li>
              <li>
                <Link href="/services/structural-modifications" className="text-gray-700 hover:text-[#B95927] transition text-lg">
                  Structural Modifications
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-700 hover:text-[#B95927] transition text-lg">
                  All Framing Services
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-300 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-lg text-center lg:text-left">
              © {new Date().getFullYear()} Home Framing LTD. Structural Excellence Guaranteed.
            </p>
