    ...
    <section className="relative w-full min-h-[500px] sm:min-h-[100svh] flex items-start sm:items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-0 text-center text-white">
        ...
        <motion.h1
          ...
          className="font-bold mb-4 sm:mb-6 text-[1.8rem] leading-[2.3rem] sm:text-[2.6rem] sm:leading-[3.2rem] md:text-[3.2rem] md:leading-[3.8rem] lg:text-[4rem] lg:leading-[4.5rem] xl:text-[4.5rem] xl:leading-[5rem]"
        >
        ...
        <motion.p
          ...
          className="mb-6 sm:mb-10 max-w-xs sm:max-w-2xl lg:max-w-4xl mx-auto text-[0.95rem] leading-[1.7rem] sm:text-[1.1rem] sm:leading-[1.9rem] lg:text-[1.2rem] lg:leading-[2rem] text-gray-200"
        >
        ...
        >
          <Link
            href="/contact"
            className="inline-block bg-[#B95927] text-white font-semibold rounded-xl shadow-xl hover:bg-[#a04d20] transition-all duration-300 hover:scale-105 px-6 py-3 sm:px-10 sm:py-4 text-sm sm:text-lg"
          >
